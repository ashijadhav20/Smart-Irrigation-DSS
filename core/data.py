...
# NDVI is not assigned one universal Kc equation here. Crop-specific alpha values are
# conservative research starting values for the stage-relative correction mode only;
# they are NOT claimed as published universal calibration coefficients.
NDVI_ALPHA_BY_CROP = {
    crop: 0.30 for crop in CROPS
}
NDVI_ALPHA_BY_CROP.update({"Rice":0.25, "Wheat":0.35, "Maize":0.35, "Sugarcane":0.30, "Cotton":0.30})
